...
$("#formCorreos #btnRegistro").click(function(event) {
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            if (response === "success") {
                ...
                $("#formCorreos #result").html("<div class='alert alert-danger text-center'>Error al registrar el correo, este ya existe.</div>");
                $("#formCorreos #email").focus();
...
var eliminar_correo_dataTable = function(tbody, table){
	...
	$(tbody).on("click", "button.table_eliminar", function(){
        ...
        eliminarCorre(data.email, data.clientes_id);
	});
}

function eliminarCorre(email, clientes_id){
	swal({
	  title: "¿Estas seguro?",
...
function deleteEmail(email, clientes_id) {
    ...
    $.ajax({
        type: 'POST',
        url: url,
        data: 'email=' + email + '&clientes_id=' + clientes_id,
        success: function (response) {
