                ...
                <div class="form-row visible" id="grupo-user">
                    <div class="col-md-3 mb-12">
                        ...
                        <div class="input-group mb-3">
                            <select class="selectpicker" id="clientes_id" name="clientes_id" required data-size="7"
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <div class="input-group mb-3">
                            <input type="password" class="form-control" id="contrasena" name="contrasena" required
                                data-toggle="tooltip" data-placement="top"
                                title="La contraseña debe ser menor a 8 caracteres">
                            <div class="input-group-append">
                                <span class="input-group-text">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="input-group mb-3">
                            <input type="text" class="form-control" id="nombre" name="nombre" required
                                data-toggle="tooltip" data-placement="top" title="Es el nombre del usuario">
                            <div class="input-group-append">
                                <span class="input-group-text">
        ...
        <div class="content-container-fluid">
            <div class="card-body">
                <div class="table-responsive">
                    <table id="dataTableUsuarios" class="table table-striped table-condensed table-hover"
                        style="width:100%">
                        <thead>
                            <tr>
                                <th>Empresa</th>
